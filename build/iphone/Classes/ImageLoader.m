...
-(void)queueRequestDidFinish:(ASIHTTPRequest*)request
{
	...
	if ([req cancelled]==NO)
	{
		...
		if (data == nil || [data length]==0)
		{
			...
			NSError *error = [NSError errorWithDomain:@"com.samplemultidevicetabbedapplication._samplemultidevicetabbedapplication.imageloader" code:1 userInfo:errorDetail];
