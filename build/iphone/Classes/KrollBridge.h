...
@interface samplemultidevicetabbedapplicationObject : KrollCoverageObject {
#else
@interface samplemultidevicetabbedapplicationObject : KrollObject {
#endif
@private
...
extern NSString * samplemultidevicetabbedapplication$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	samplemultidevicetabbedapplicationObject *_samplemultidevicetabbedapplication;
    KrollObject* console;
	BOOL shutdown;
