...
MAKE_SYSTEM_PROP(ACTIVITY,UIsamplemultidevicetabbedapplicationNativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UIsamplemultidevicetabbedapplicationNativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UIsamplemultidevicetabbedapplicationNativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UIsamplemultidevicetabbedapplicationNativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UIsamplemultidevicetabbedapplicationNativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UIsamplemultidevicetabbedapplicationNativeItemContactAdd);
