...
/**
 The base class for all samplemultidevicetabbedapplication modules
 */
...
/**
 samplemultidevicetabbedapplication Platform calls this method on startup.
 */
-(void)startup;

/**
 samplemultidevicetabbedapplication Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 samplemultidevicetabbedapplication Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 samplemultidevicetabbedapplication Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 samplemultidevicetabbedapplication Platform calls this method on resume.
 @param sender The sender of the event.
 */
