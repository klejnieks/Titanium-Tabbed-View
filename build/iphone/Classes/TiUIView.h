...
/**
 Base class for all samplemultidevicetabbedapplication views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the samplemultidevicetabbedapplication view hierarchy (such as wrapped iOS UIViews) was touched.
