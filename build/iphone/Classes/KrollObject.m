 ...
 * Copyright (c) 2009-2011 by samplemultidevicetabbedapplication, Inc. All Rights Reserved.
...
//@interface samplemultidevicetabbedapplicationObject : NSObject
//@end

@interface samplemultidevicetabbedapplicationObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[samplemultidevicetabbedapplicationObject class]])
		{
			for (NSString *key in [[(samplemultidevicetabbedapplicationObject*)o modules] allKeys])
			{
