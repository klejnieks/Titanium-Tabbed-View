...
// in simulator we redefine to format for samplemultidevicetabbedapplication Developer console
...
{\
	NSString * exceptionName = [@"org.samplemultidevicetabbedapplication." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.samplemultidevicetabbedapplication";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIsamplemultidevicetabbedapplicationNativeItemNone = -1, 
	UIsamplemultidevicetabbedapplicationNativeItemSpinner = -2,
	UIsamplemultidevicetabbedapplicationNativeItemProgressBar = -3,
	
	UIsamplemultidevicetabbedapplicationNativeItemSlider = -4,
	UIsamplemultidevicetabbedapplicationNativeItemSwitch = -5,
	UIsamplemultidevicetabbedapplicationNativeItemMultiButton = -6,
	UIsamplemultidevicetabbedapplicationNativeItemSegmented = -7,
	
	UIsamplemultidevicetabbedapplicationNativeItemTextView = -8,
	UIsamplemultidevicetabbedapplicationNativeItemTextField = -9,
	UIsamplemultidevicetabbedapplicationNativeItemSearchBar = -10,
	
	UIsamplemultidevicetabbedapplicationNativeItemPicker = -11,
	UIsamplemultidevicetabbedapplicationNativeItemDatePicker = -12,
	
	UIsamplemultidevicetabbedapplicationNativeItemInfoLight = -13,
	UIsamplemultidevicetabbedapplicationNativeItemInfoDark = -14,
	
	UIsamplemultidevicetabbedapplicationNativeItemDisclosure = -15,
	
	UIsamplemultidevicetabbedapplicationNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all samplemultidevicetabbedapplication instances of
