...
//Rare exceptions to indicate a bug in the _samplemultidevicetabbedapplication code (Eg, function that a subclass should have implemented)
...
/**
 The base class for samplemultidevicetabbedapplication proxies.
 */
